...
public class TestServiceImpl implements TestService {
  ...
  public List<Case> testBatchReturnFiltered() {
    List<Case> result = new ArrayList<>();
  ...
  public Set<CaseDTO> testBatchReturnFilteredByNestedId() {
    Set<CaseDTO> result = new HashSet<>();
    CaseDTO caseDTO = new CaseDTO();
  ...
  public List<CaseDTO> testBatchReturnFilteredByNestedObject() {
    List<CaseDTO> result = new ArrayList<>();
    CaseDTO caseDTO = new CaseDTO();
    caseDTO.setCaseObject(new Case(1L, "invalid"));
    result.add(caseDTO);
  ...
  @Override
  public List<Case> testBatchFilterArgument(@Authorize("case:filter:caseList") List<Case> caseList) {
    return caseList;
  }

  @Override
  public List<CaseDTO> testBatchFilterArgumentByNestedId(@Authorize("case:filter:caseDTO.caseObject.id") List<CaseDTO> caseDTOList) {
    return caseDTOList;
  }

  @Override
  public Set<CaseDTO> testBatchFilterArgumentByNestedObject(@Authorize("case:filter:caseDTO.caseObject") Set<CaseDTO> caseDTOSet) {
    return caseDTOSet;
  }
}
