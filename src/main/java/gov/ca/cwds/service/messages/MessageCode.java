...
public enum MessageCode {
  ...
  OFFICE_ADMIN_CANNOT_VIEW_USERS_WITH_SUPER_ADMIN_ROLE("CAP-062"),
  COUNTY_ADMIN_CANNOT_VIEW_USERS_WITH_SUPER_ADMIN_ROLE("CAP-063"),
  STATE_ADMIN_CANNOT_VIEW_USERS_WITH_SUPER_ADMIN_ROLE("CAP-064");
