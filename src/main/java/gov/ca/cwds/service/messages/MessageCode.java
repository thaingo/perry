...
public enum MessageCode {
  ...
  CALS_ADMIN_CANNOT_UPDATE_USER("CAP-045"),
  COUNTY_ADMIN_CANNOT_UPDATE_USER_FROM_OTHER_COUNTY("CAP-046"),
  COUNTY_ADMIN_CANNOT_UPDATE_STATE_ADMIN("CAP-047"),
  ROLE_IS_UNSUFFICIENT_FOR_OPERATION("CAP-048"),
  OFFICE_ADMIN_CANNOT_UPDATE_USER_FROM_OTHER_COUNTY("CAP-049"),
  OFFICE_ADMIN_CANNOT_UPDATE_ADMIN("CAP-050"),
  CALS_ADMIN_CANNOT_RESEND_INVITATION_MESSAGE("CAP-051"),
  COUNTY_ADMIN_CANNOT_RESEND_INVITATION_FOR_USER_FROM_OTHER_COUNTY("CAP-052"),
  OFFICE_ADMIN_CANNOT_RESEND_INVITATION_FOR_USER_FROM_OTHER_OFFICE("CAP-053");
