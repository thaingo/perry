...
public class MessagesServiceTest {
  ...
  public void testGet() {
    assertThat(
        messagesService.getTech(IDM_MAPPING_SCRIPT_ERROR), is("Error while running the IdmMappingScript"));
    assertThat(
        messagesService.getTech(NO_USER_WITH_RACFID_IN_CWSCMS, "ABCDEF"),
